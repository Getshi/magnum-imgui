...
public:
  ...
  void newFrame(const Magnum::Vector2i &winSize,
  ...
  bool
  mouseReleaseEvent(const Magnum::Platform::Application::MouseEvent &event);

  bool mouseScrollEvent(
      const Magnum::Platform::Application::MouseScrollEvent &event);

  bool
  mouseMoveEvent(const Magnum::Platform::Application::MouseMoveEvent &event);
  ...
  bool
  textInputEvent(const Magnum::Platform::Application::TextInputEvent &event);
...
private:
  ...
  bool
  keyPressReleaseEvent(const Magnum::Platform::Application::KeyEvent &event,
                       bool value);
  bool
  mousePressReleaseEvent(const Magnum::Platform::Application::MouseEvent &event,
                         bool value);
};
